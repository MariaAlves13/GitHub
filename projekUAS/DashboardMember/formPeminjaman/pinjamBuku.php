...
<html lang="en">
  ...
  <div class="p-4 mt-5">
      ...
      <div class="card-body d-flex flex-wrap gap-4 justify-content-center">
        ...
        <form action="" method="post">
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="semester" aria-label="semester" aria-describedby="basic-addon1" value="<?= $item["semester"]; ?>" readonly>
            </div>
          <div class="input-group mb-3">
    ...
    <div class="card mt-4">
      ...
      <div class="card-body">
        <form action="" method="post">
          ...
          <?php endforeach; ?>
        <!-- Ambil data NIM user yang login-->
        <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">Nim</span>
    ...
    <div class="input-group mb-3 mt-3">
            <span class="input-group-text" id="basic-addon1">Tanggal Pengembalian</span>
